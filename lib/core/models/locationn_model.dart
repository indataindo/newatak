class LocationnModel {
  double latitude;
  double longitude;
  int polygonID;

  LocationnModel({this.latitude, this.longitude, this.polygonID});

  factory LocationnModel.fromMap(Map<String, dynamic> map) {
    //var kedoublelat = double.parse(map['latitude']);
    //var kedoublelang = double.parse(map['longitude']);

    return LocationnModel(
